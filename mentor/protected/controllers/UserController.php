...
class UserController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow',  // Allow users to view/update their own model.
				'actions'=>array('view','update'),
				'users'=>array('@'),
		    'expression'=>'$user->id == (int)Yii::app()->getRequest()->getQuery("id")',
			),
			array('allow',  // Allow guests to create new model.
